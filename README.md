...
- **📍 Хаяг** (эхний мөр) ба **🕒 Нийтэлсэн огноо** (ЯГ доорх мөр) — хоёулаа
  **зүүн тийш** зэрэгцсэн, байрны мэдээллийн (🛏 өрөө / 📐 м² / 🏢 давхар / 📅 он)
  **ӨМНӨ** байрлана (`lib/format.js` → `formatAddress()`)
- Дэлгэрэнгүй хуудсанд ч мөн адил (`📍 Байршил` + доор нь `📅 Нийтэлсэн`)
