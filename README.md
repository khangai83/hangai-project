...
| **Категори + Төрөл** | Зарах/Түрээслэх таб, дараа нь төрлийн табууд (зарын тоо бүхий) |
| **Sidebar (зүүн)** | Байршил · Үнэ, ₮ · Талбай, м² — `lg` дээр **байнга** харагдана, `lg:sticky` |
...
- **Мобайл** (`lg`-ээс доош): sidebar нь НУУГДАЖ, баруун талын «⚙️ Шүүлт» товчоор
  нээгдэнэ. Товч нь DOM-д sidebar-ийн ӨМНӨ байрлана → нээгдэхэд шүүлт **дээгүүр** гарна.
...
| Харагдах нөхцөл | `hasRoomsFields(type)` — «Худалдаа, үйлчилгээний талбай», Оффис, Газар, Үйлдвэр, Гараж зэрэгт мөр **БҮРЭН харагдахгүй** (тоо ч татахгүй) |
