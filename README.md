...
────────────────────────────────────────────────────────────────────────────────────
📍 Хангай дүүрэг 16-р байр, 5-р хороо, Баянгол, Улаанбаатар        🕒 2 цагийн өмнө
👁 12                                                    🤍 5
```

- **Мэдээллийн баганы ДООД ХЭСЭГ** нь зураас (`border-t`) тусгаарласан блок бөгөөд
  дотроо 2 мөртэй:
  1. **📍 Хаяг (зүүн) + 🕒 Нийтэлсэн (баруун)** — `justify-between`-ээр хоёр захад
     (`lib/format.js` → `formatAddress()`)
  2. **👁 үзсэн** ба **🤍/❤️ таалагдсан** тоолуур
- Огноог **🕒** (цаг) гэж тэмдэглэв — баригдсан он (📅) хоёр 📅 зөрөхөөс сэргийлсэн
