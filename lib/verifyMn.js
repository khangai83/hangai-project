...
function requireApiKey() {
  ...
  if (!key) {
    const err = new Error(
      'VERIFY_MN_API_KEY тохируулаагүй байна. verify.mn → Developer Console → API KEY-г ' +
        '.env.local файлд нэмээд dev server-ээ дахин эхлүүлнэ үү.'
    );
...
// (сервер талд нэг эх сурвалж: verify.mn 8 оронтой локал, Supabase +976...)
